...
class SurveyUploadForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['data_link'].label = "Link to Data (Enter 'NA' if link is not available)"
        self.fields['doc_link'].label = "Link to Documentation (Enter 'NA' if link is not available)"
        self.fields['source_link'].label = "Link to Source (Enter 'NA' if link is not available)"
